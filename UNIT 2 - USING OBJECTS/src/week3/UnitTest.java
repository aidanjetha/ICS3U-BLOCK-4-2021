...
public class UnitTest {
    public static void main(String[] args) {
        ...
        System.out.println(removeChars("Tired", 2, 2));
        System.out.println(sqrtSum(9999));

    }

    /**
     * Write a function that excepts a string and an integer. Return 3 copies of a 
        substring of length 2 at the specified index.
     */

    //Three copies("Happy", 2) => "pppppp"
    public static String threeCopies(String str, int index) {
       ...
       public static double sqrtSum(int, number){
           ...
           int n2 = number / 100 % 10; // 7463 / 100 = 74. 74 % 10 = 4
           int n3 = number / 10 % 10; //7463 / 10 = 746. 746 % 10 = 6
           int n4 = number % 10; //7463 % 10 = 3
  
           int sum = n1 + n2 + n3 + n4;
           return Math.sqrt(sum); //Always static when in Math. class
